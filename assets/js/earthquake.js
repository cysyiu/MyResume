...
const pxPerKm = 0.00639; // Pixels per kilometer at zoom level 0
        ...
        earthquake.features.forEach((featureData) => {
            ...
            if (alert !== null && (!alertLevel || alert === alertLevel)) {
                ...
                if (eventTime >= startDate && eventTime <= endDate) {
                    ...
                    // Calculate influence area radius in kilometers
                    const influenceRadiusKm = Math.pow(10, 0.43 * mag);

                    // Convert influence radius to pixels
                    const hollowCircleRadiusPx = influenceRadiusKm * pxPerKm;
